...
## Project Structure
The project has a simple structure with all source code in the src/ directory containing 9 Python modules:
...
## Dependencies
Note: The project does not include a requirements.txt or pyproject.toml file. However, based on the imports in the code, the required dependencies are:
...
4. **Vector Storage** - Persistent ChromaDB storage for document chunks and embeddings
